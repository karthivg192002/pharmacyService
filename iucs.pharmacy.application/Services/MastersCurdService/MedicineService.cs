...
{
    public class MedicineService : CrudService<MedicineDto, Medicine>
    {
        public MedicineService(AppDbContext db, IMapper mapper, ILogger<MedicineService> logger) : base(db, mapper, logger)
        {
        }
    }
}
