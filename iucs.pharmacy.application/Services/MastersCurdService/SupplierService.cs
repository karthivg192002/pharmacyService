...
{
    public class SupplierService : CrudService<SupplierDto, Supplier>
    {
        public SupplierService(AppDbContext db, IMapper mapper, ILogger<SupplierService> logger) : base(db, mapper, logger)
        {
        }
    }
}
